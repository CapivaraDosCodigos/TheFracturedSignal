...
# 🚫 flag para parar movimento quando colidir com uma área
...
func follower_physics() -> void:
	if leader == null or not no_player:
		return
	...
	# garante que o líder tenha trilha suficiente
	...
	# 👉 pega o ponto mais antigo da trilha, não o último
	var target_pos = leader.trail[trail_length - 1]
